    ...
    <section className="py-28 px-5">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {/* Outer glow */}
            <div className="absolute -inset-4 bg-[#0ea5e9]/[0.04] blur-2xl pointer-events-none" />
            ...
            <div className="relative overflow-hidden border border-white/[0.09] shadow-2xl bg-[#0b0d10]">
              ...
              <div className="flex items-center justify-between px-4 py-2 border-t border-white/[0.07] bg-[#111]">
                <span className="text-[10px] text-white/25 font-mono tracking-[0.16em] uppercase">live scene</span>
                <span className="text-[10px] text-white/25 font-mono tracking-[0.16em] uppercase">60 TPS physics</span>
              </div>
            </div>
          </motion.div>
        </div>
